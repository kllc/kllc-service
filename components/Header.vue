  ...
  <el-header class="head">
    <div class="logo">
      <svg
        ...
        y="0px"
        viewBox="0 0 680 230"
        style="enable-background: new 0 0 680 230"
        xml:space="preserve"
      >
        <style type="text/css">
          .st0 {
        ...
        <g class="st0">
          ...
          <path
            d="M679.2,218.1c-16.2,7.8-37.2,11.7-63.3,11.7c-33.9,0-60.6-10-80.1-29.9c-19.4-20-29.2-46.5-29.2-79.8
    ...
    <div>
      <div class="title">Product and Service</div>
    </div>
  </el-header>
</template>
